...
export default function One() {
  ...
  const data = ["/adam/classicLogoBlack.jpg", "/adam/classicLogoBlackB.jpg"];
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Gallery list={data} defaultValue="/adam/classicLogoBlack.jpg" />

          <div>
            <div className="grid grid-cols-4">
              <div className="text-xl col-span-3">Adam Krum Classic T-shirt Black</div>
